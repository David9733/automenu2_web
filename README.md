...
## 초기 기획 프롬프트 
기존 앱을 개발하고 있는 프로젝트에서 AI 보조도구를 이용해 프롬프트 입력

- next.js기반으로 랜딩페이지를 만들고 싶어. 개인정보처리방침까지 포함해서. 그걸 만들기 위한 프롬프트를 줘봐
...
- Context
 ...
 ---
 Next.js 14 (App Router) + TypeScript + Tailwind CSS로 "이따가 뭐 먹지" 모바일 앱의 랜딩페이지를 완성된 코드로 만들어주세요. 모든 파일을 실행 가능한 상태로 작성해주세요.
 ...
 본 앱은 쿠키를 사용하지 않습니다. 다만, 서비스 분석 및 광고 제공을 위해 Firebase Analytics와 광고 식별자를 사용할 수 있습니다.
