...
Flutter 앱 "이따가 뭐 먹지?"를 Google Play Store에 출시하면서, 앱을 소개하고<br>
스토어 등록 요건을 충족하는 개인정보처리방침을 제공하기 위해 제작한 랜딩 페이지입니다.

| 구분 | 내용 |
|------|------|
| **필요 배경** | Google Play Store 출시 시 개인정보처리방침 공개 URL 필수 제출 |
| **본 서비스** | 앱 기능 소개 + 개인정보처리방침을 하나의 웹사이트로 통합 제공 |
